...
This document summarizes the recent improvements made to the simple-smbd project, focusing on code reorganization and project structure.
...
**Files:**
- `include/simple-smbd/core/app.hpp` - Application interface
- `src/simple-smbd/core/app.cpp` - Application implementation
