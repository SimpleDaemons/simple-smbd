...
useradd -m -s /bin/bash smbddev || true
usermod -aG sudo smbddev || true

# Create project directory
echo "Setting up project directory..."
PROJECT_DIR="/opt/simple-smbd"
mkdir -p $PROJECT_DIR
chown smbddev:smbddev $PROJECT_DIR

# Create log directories
echo "Creating log directories..."
mkdir -p /var/log/simple-smbd
chown smbddev:smbddev /var/log/simple-smbd

# Create config directory
echo "Creating config directory..."
mkdir -p /etc/simple-smbd
chown smbddev:smbddev /etc/simple-smbd
...
echo "2. Run: cd $PROJECT_DIR && sudo -u smbddev ./build.sh"
echo "3. Test with: sudo -u smbddev make test"
