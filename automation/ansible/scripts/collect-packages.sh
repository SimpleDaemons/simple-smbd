...
REMOTE_PROJECT_DIR="/opt/simple-smbd"
...
- name: Collect packages from remote VMs
  ...
  vars:
    ...
    remote_dist_dir: "/opt/simple-smbd/dist"
    remote_build_dir: "/opt/simple-smbd/build"
    remote_centralized_dir: "/opt/simple-smbd/dist/centralized/v$VERSION"
